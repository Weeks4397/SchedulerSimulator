 ...
 * This class extends Scheduler_with_NoTimeOut so that preemption is possible during each event.
 ...
 *              process can run.
 */
public abstract class Scheduler_with_Preemption_NoTimeOut extends Scheduler_without_TimeOut {
